...
/* package zin-compiler-0.1.0.0 */
#ifndef VERSION_zin_compiler
#define VERSION_zin_compiler "0.1.0.0"
#endif /* VERSION_zin_compiler */
#ifndef MIN_VERSION_zin_compiler
#define MIN_VERSION_zin_compiler(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_zin_compiler */
...
#define CURRENT_COMPONENT_ID "zin-compiler-0.1.0.0-inplace-zin-compiler-test"
